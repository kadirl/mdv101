...
VL_INLINE_OPT void Vcontrol_unit___024root___ico_sequent__TOP__0(Vcontrol_unit___024root* vlSelf) {
    ...
    if ((2U & (IData)(vlSelfRef.control_unit__DOT__state))) {
        if ((1U & (IData)(vlSelfRef.control_unit__DOT__state))) {
            if ((1U & (~ ((IData)(vlSelfRef.d_in) >> 0xfU)))) {
        ...
        if ((1U & (~ (IData)(vlSelfRef.control_unit__DOT__state)))) {
            vlSelfRef.mux_sel = (7U & ((IData)(vlSelfRef.d_in) 
                                       >> 0xaU));
            vlSelfRef.alu_sel = (0xfU & ((IData)(vlSelfRef.d_in) 
                                         >> 3U));
            vlSelfRef.alu_mode = (1U & ((IData)(vlSelfRef.d_in) 
                                        >> 2U));
        }
...
VL_INLINE_OPT void Vcontrol_unit___024root___nba_sequent__TOP__0(Vcontrol_unit___024root* vlSelf) {
    ...
    // Body
    if (vlSelfRef.reset) {
        vlSelfRef.control_unit__DOT__state = 0U;
    } else if (vlSelfRef.run) {
        vlSelfRef.control_unit__DOT__state = vlSelfRef.control_unit__DOT__next_state;
    }
    vlSelfRef.en_s = 0U;
    vlSelfRef.done = 0U;
    vlSelfRef.en_i = 0U;
