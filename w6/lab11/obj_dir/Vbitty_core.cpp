...
Vbitty_core::Vbitty_core(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , reg_instr_out{vlSymsp->TOP.reg_instr_out}
    , reg_s_out{vlSymsp->TOP.reg_s_out}
    , reg_c_out{vlSymsp->TOP.reg_c_out}
    , reg0_out{vlSymsp->TOP.reg0_out}
    , reg1_out{vlSymsp->TOP.reg1_out}
    , reg2_out{vlSymsp->TOP.reg2_out}
    , reg3_out{vlSymsp->TOP.reg3_out}
    , reg4_out{vlSymsp->TOP.reg4_out}
    , reg5_out{vlSymsp->TOP.reg5_out}
    , reg6_out{vlSymsp->TOP.reg6_out}
    , reg7_out{vlSymsp->TOP.reg7_out}
