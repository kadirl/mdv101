...
#ifndef VERILATED_VBITTY_CORE_H_
...
class alignas(VL_CACHE_LINE_BYTES) Vbitty_core VL_NOT_FINAL : public VerilatedModel {
  ...
  public:
    ...
    Vbitty_core___024root* const rootp;
    ...
    explicit Vbitty_core(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vbitty_core(const char* name = "TOP");
