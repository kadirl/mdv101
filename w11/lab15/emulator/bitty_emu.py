...
def fibonacci(emulator: BittyEmulator, n: int) -> bool:
...
if __name__ == "__main__":
    ...
    # result = fibonacci(emulator, 100)
    # if result:
    #     print("Fibonacci test passed.")

    # test random instructions
    # gen = BittyInstructionGenerator()
    # for _ in range(10):
    #     instruction = gen.generate()
    #     print(f"Generated instruction: {instruction:016b}")
